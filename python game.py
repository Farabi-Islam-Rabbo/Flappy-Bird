...
bird = [pygame.image.load('data/birdup.png'), pygame.image.load('data/birdup.png'),
        pygame.image.load('data/birdown.png'), pygame.image.load('data/birdown.png')]
...
# menu page
while not (run):
    text3 = fonter.render('Made by:Shariful Islam Farabi', 1, (255, 255, 255))
